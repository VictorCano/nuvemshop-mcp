...
// Mock the fulfillment tools so they don't call real methods on the mock server
vi.mock('../src/tools/fulfillment.js', () => ({
  registerFulfillmentTools: vi.fn(),
}));

// Mock the order tools so they don't call real methods on the mock server
vi.mock('../src/tools/orders.js', () => ({
...
// Mock the coupon tools so they don't call real methods on the mock server
vi.mock('../src/tools/coupons.js', () => ({
  registerCouponTools: vi.fn(),
}));

// Mock the customer tools so they don't call real methods on the mock server
vi.mock('../src/tools/customers.js', () => ({
  registerCustomerTools: vi.fn(),
}));
